...
public class MarvellousLogin extends Template implements ActionListener, Runnable {
	...
	public MarvellousLogin()
	{
		...
		TopLabel.setText("Marvellous packet unpacker : Login");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource() == SUBMIT)
		{
			...
			else
			{
				...
				if(attemp == 0)
				{
					JOptionPane.showMessageDialog(this, "Number of attemts Finished","Marvellous Packer UnPacker",JOptionPane.ERROR_MESSAGE);
					this.dispose();
					System.exit(0);
				}
